...
const BackgroundCircles = () => {
  return (
    <motion.div
      ...
      className='relative flex justify-center items-center sm:pt-[100px] md:pt-[150px] lg:pt-[180px]'>
      ...
      <div className='rounded-full border border-[#333333] h-[300px] w-[300px] sm:h-[300px] sm:w-[300px] md:h-[300px] md:w-[300px] lg:h-[300px] lg:w-[300px] absolute mt-52' />
      <div className='rounded-full border border-[#333333] h-[300px] w-[300px] sm:h-[400px] sm:w-[400px] md:h-[450px] md:w-[450px] lg:h-[500px] lg:w-[500px] absolute mt-52' />
